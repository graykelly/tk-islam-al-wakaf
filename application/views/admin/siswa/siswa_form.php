...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold"><?= ucfirst($page); ?> Data Siswa</h6>
            <div>
                <a href="<?= base_url('admin/siswa') ?>" class="btn btn-warning mt-3">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <?php echo form_open_multipart('admin/siswa/process') ?>
                    <div class="form-group">
                        <label for="nis">NIS *</label>
                        <input type="hidden" name="id" value="<?= $row->siswa_id ?>">
                        <input type="text" name="nis" id="nis" value="<?= $row->nis ?>" class="form-control" required>
                    </div>
                    <div class="form-group">
                        ...
                        <?php if ($page == 'edit') {
                            if ($row->foto != null) { ?>
                                <div style="margin-bottom:8px">
                                    <img src="<?= base_url('assets/images/siswa/' . $row->foto) ?>" style="width:30%">
                                </div>
                        <?php
                            }
                        } ?>
